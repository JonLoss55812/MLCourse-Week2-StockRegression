# -*- coding: utf-8 -*-
"""MLWeek2_Homework.pynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lUts3QfLQhgKfU4YXSPRaJ3NWyIlkOWQ
"""
...
datasetfreg['HL_PCT'] = (dataset['High'] - dataset['Low']) / dataset['Close'] * 100.0
datasetfreg['PCT_change'] = (dataset['Close'] - dataset['Open']) / dataset['Open'] * 100.0
...
for i in forecast_set:
    ...
    datasetfreg.loc[next_date] = [np.nan for _ in range(len(datasetfreg.columns)-1)]+[i]
